...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onStart() {
        super.onStart();
        //DO the REFRESH Action for the first time as Natan proposed
        updateWeather();
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]>{
        ...
        public String[] doInBackground(String... params)
        {
            ...
            try {
                String formatChoice = "json";
                String unitChoice = "metric";
                String daysChoice = "7";
                ...
                Uri uri = Uri.parse(baseUrl).buildUpon()
                        //accepting one of the url params from the function's parameters
                        .appendQueryParameter(query, params[0])
                        .appendQueryParameter(format,formatChoice)
                        .appendQueryParameter(units, unitChoice)
                        .appendQueryParameter(days,daysChoice)
                        .build();
            ...
            try {
                String[] retVal = getWeatherDataFromJson(forecastJsonStr, numOfDays);
                return retVal;
 ...
 */
    ...
    public String[] getWeatherDataFromJson(String forecastJsonStr, int numDays)
        ...
        for (String s : resultStrs) {
            Log.v(MainActivity.LOG_TAG, "Forecast entry: " + s);
        }
        return resultStrs;
    }
}
